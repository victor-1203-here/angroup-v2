...
const highlights = [
    {
        ...
        imageSrc: '/v2/images/home/highlight_1.jpg',
    },
    {
        ...
        imageSrc: '/v2/images/home/highlight_2.jpg',
    },
    {
        ...
        imageSrc: '/v2/images/home/highlight_3.jpg',
    },
    {
        ...
        imageSrc: '/v2/images/home/highlight_4.jpg',
    },
    {
        title: 'Committed to Energy Transition',
        description: (
        ...
        imageSrc: '/v2/images/home/highlight_5.jpg',
    },
];
        ...
        <>
            ...
            <section className="mx-auto max-w-[96rem] px-8 py-12">
                ...
                <div className="flex flex-col gap-6 md:flex-row">
                    {[
                        {
                            src: '/v2/images/home/journey_1.jpg',
                        ...
                        {
                            src: '/v2/images/home/journey_2.jpg',
                        ...
                        {
                            src: '/v2/images/home/journey_3.jpg',
            ...
            <section className="mx-auto max-w-4xl px-4 py-14">
                ...
                <div className="mb-10 overflow-hidden rounded-[2.5rem] shadow-lg">
                    <div className="relative">
                        <Image
                            src="/v2/images/home/vision_bg.jpg"
                            alt="Vision"
                ...
                <div className="mb-10 overflow-hidden rounded-[2.5rem] shadow-lg">
                    <div className="relative">
                        <Image src="/v2/images/home/mission_bg.jpg" alt="Mission" width={1920} height={224} className="h-56 w-full object-cover" />
                        <div className="absolute inset-0 bg-black opacity-50"></div>
                        <div className="absolute inset-0 flex flex-row items-center justify-between gap-10 p-8 md:mx-12">
                ...
                <div className="overflow-hidden rounded-[2.5rem] shadow-lg">
                    <div className="relative">
                        <Image src="/v2/images/home/values_bg.jpg" alt="Values" width={1920} height={224} className="h-56 w-full object-cover" />
                        <div className="absolute inset-0 bg-black opacity-50"></div>
                        <div className="absolute inset-0 flex flex-row items-center justify-between gap-10 p-8 md:mx-12">
